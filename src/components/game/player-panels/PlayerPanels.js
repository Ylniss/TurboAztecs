...
export const PlayerPanels = () => {
  ...
  const getPlayerPanel = (color) => {
    ...
    switch (color) {
      case "#47cf31":
        return (<img key='1' className='green-panel shadow' src={greenPlayerPanel} alt='greenPlayerPanel' />);
      case "#0c81f2":
        return (<img key='2' className='blue-panel shadow' src={bluePlayerPanel} alt='bluePlayerPanel' />);
      case "#d2952b":
        return (<img key='3' className='brown-panel shadow' src={brownPlayerPanel} alt='brownPlayerPanel' />);
      case "#808080":
        return (<img key='4' className='grey-panel shadow' src={greyPlayerPanel} alt='greyPlayerPanel' />);
